...
export function LivePlatformStats({ initialStats }: LivePlatformStatsProps) {
  ...
  return (
    <div className="relative z-0 mt-7 flex max-w-3xl flex-wrap items-center justify-center gap-x-5 gap-y-2 text-center text-xs font-black text-muted-foreground sm:gap-x-7 sm:text-sm">
