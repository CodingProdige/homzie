    ...
    <PublicPageShell>
      <section className="page-body py-10 lg:py-16">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-5 max-w-2xl text-sm font-semibold leading-7 text-muted-foreground sm:text-base">
            {description}
          </p>
          <p className="mt-4 text-xs font-bold uppercase tracking-[0.08em] text-muted-foreground">
        ...
        <div className="mx-auto grid max-w-4xl gap-5">
          {sections.map((section, index) => (
            <article key={section.title} className="rounded-lg border border-border bg-card p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-3 text-sm font-semibold leading-7 text-muted-foreground">
