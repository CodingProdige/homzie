  ...
  return (
    <form action={action} className="mt-6 grid gap-4">
      ...
      <label className="grid gap-2">
        ...
        <span className="flex items-center gap-2 rounded-lg border border-border bg-background px-3">
          ...
          <input
            ...
            className="h-12 min-w-0 flex-1 bg-transparent text-sm font-semibold outline-none placeholder:text-muted-foreground/70"
          />
        </span>
      </label>
          ...
          {agencyType === "branch" ? (
            <label className="grid gap-2">
              ...
              <input
                ...
                maxLength={32}
                className="h-12 rounded-lg border border-border bg-background px-3 text-sm font-semibold outline-none placeholder:text-muted-foreground/70"
              />
            </label>
          ) : null}
        </div>
      ...
      <Button
        type="submit"
        disabled={isPending}
        className="mt-2 h-12 w-full rounded-md font-black"
      >
